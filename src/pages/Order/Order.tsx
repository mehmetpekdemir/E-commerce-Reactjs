...
import { OrderError, Phone, User } from "../../types/types";
...
const Order: FC = () => {
  ...
  const onFormSubmit = (event: FormEvent<HTMLFormElement>): void => {
    ...
    const phonesId = Object.fromEntries(
      new Map(JSON.parse(localStorage.getItem("phones") as string))
    );
                    ...
                    >
                      <div className="card mb-5">
                        ...
                        <div className="card-body text-center">
                          ...
                          <h6>
                            <span>
                              Quantity: {phonesFromLocalStorage.get(phone.id)}
                            </span>
                          </h6>
                        </div>
                      </div>
