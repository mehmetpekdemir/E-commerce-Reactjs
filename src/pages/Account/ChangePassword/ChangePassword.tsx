...
import { updateUserPassword } from "../../../redux/thunks/user-thunks";
import "./ChangePassword.css";

const ChangePassword: FC = () => {
  const dispatch = useDispatch();
  const errors: Partial<AuthErrors> = useSelector(
    (state: AppStateType) => state.user.userResetPasswordErrors
  );
  const success: string = useSelector(
    (state: AppStateType) => state.user.successMessage
  );
