...
const usePagination: ({
  ...
  slicedData: Array<Phone>;
  prevPage: (event: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => void;
} = ({ itemsPerPage, phones, startFrom }) => {
  const [searching, setSearching] = useState<boolean>(false);
  const [filteredData, setFilteredData] = useState<Array<Phone>>(phones);
  ...
  const [slicedData, setSlicedData] = useState<Array<Phone>>(
